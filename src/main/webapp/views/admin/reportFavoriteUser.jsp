    ...
    <div class="main-container">
        ...
        <div class="report-section">
            <div class="report-header">
                <h2><i class="fas fa-users me-2"></i>Báo Cáo Người Dùng Yêu Thích</h2>
                <p>Thống kê chi tiết người dùng theo video</p>
            </div>
            ...
            <div class="video-select">
                <form id="videoForm" action="${pageContext.request.contextPath}/admin/reportFavoriteUser" 
                      method="post" class="mb-3">
                    <select class="form-select" aria-label="Default select example" 
                            name="id" onchange="submitForm()">
                        <option selected disabled>Chọn video để xem thống kê</option>
                ...
                <table class="table">
                    <thead>
                        <tr>
                            ...
                            <th scope="col"><i class="fas fa-calendar-alt me-2"></i>Favorite Date</th>
                        </tr>
                    </thead>
                    <tbody>
                        <c:choose>
                            <c:when test="${not empty listReportFavoriteUser}">
                                <c:forEach var="item" varStatus="loop" items="${listReportFavoriteUser}">
                                    <tr>
                                        ...
                                        <td>${item.fullname}</td>
                                        <td>
                                            <i class="fas fa-envelope me-2 text-muted"></i>${item.email}
                                        </td>
                                        <td>
